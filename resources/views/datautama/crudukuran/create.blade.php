<x-layout>
    ...
    <h1 class="pb-2 mb-4 text-2xl font-semibold text-gray-800 border-b-2 border-gray-300">
        <span class="text-blue-600">Tambah Ukuran</span>
    </h1>

    <form action="{{ route('ukuran.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="ukuran" id="ukuran" maxlength="50"
