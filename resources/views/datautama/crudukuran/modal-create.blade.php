<!-- Main modal -->
<div id="tambah-ukuran-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="tambah-ukuran-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('ukuran.store') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                @csrf
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="ukuran" id="ukuran"
                            ...
                            placeholder="Nama ukuran barang anda" required="" value="{{ old('ukuran') }}">
                        @error('ukuran')
