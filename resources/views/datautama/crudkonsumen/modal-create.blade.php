<!-- Main modal -->
<div id="tambah-konsumen-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="tambah-konsumen-modal">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            placeholder="Nama konsumen toko anda" required="" value="{{ old('nama') }}">
                        @error('nama')
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="alamat" id="alamat" rows="4"
                            ...
                            required placeholder="Alamat konsumen toko anda">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="number" name="telepon" id="telepon" maxlength="20"
                            ...
                            required placeholder="No Telepon konsumen toko anda" value="{{ old('telepon') }}">
                        @error('telepon')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
