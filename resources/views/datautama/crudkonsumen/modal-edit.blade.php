@foreach ($konsumens as $konsumen)
    <!-- Main modal -->
    <div id="edit-konsumen-modal{{ $konsumen->id_konsumen }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('konsumen.update', $konsumen->id_konsumen) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                placeholder="Nama konsumen barang anda" required=""
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="alamat" id="alamat" rows="4"
                                ...
                                required="" placeholder="Alamat konsumen barang anda">{{ old('alamat', $konsumen->alamat) }}</textarea>
                            @error('alamat')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="number" name="telepon" id="telepon" maxlength="20"
                                ...
                                required placeholder="No Telepon konsumen barang anda"
                                value="{{ old('telepon', $konsumen->telepon) }}">
                            @error('telepon')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
