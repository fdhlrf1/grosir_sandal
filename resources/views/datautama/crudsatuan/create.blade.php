<x-layout>
    ...
    <h1 class="pb-2 mb-4 text-2xl font-semibold text-gray-800 border-b-2 border-gray-300">
        <span class="text-blue-600">Tambah Satuan</span>
    </h1>

    <form action="{{ route('satuan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nama_satuan" id="nama_satuan" maxlength="50"
            ...
            <div>
                ...
                <input type="number" name="konversi" id="konversi" maxlength="50"
