<!-- Main modal -->
<div id="tambah-satuan-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="tambah-satuan-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('satuan.store') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                @csrf
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_satuan" id="nama_satuan"
                            ...
                            placeholder="Satuan toko anda" required="" value="{{ old('nama_satuan') }}">
                        @error('nama_satuan')
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="number" name="konversi" id="konversi" maxlength="20"
                            ...
                            required placeholder="Nilai konversi satuan toko anda" value="{{ old('konversi') }}">
                        @error('konversi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
