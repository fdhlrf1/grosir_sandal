@foreach ($kategoris as $kategori)
    <!-- Main modal -->
    <div id="edit-kategori-modal{{ $kategori->id_kategori }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('kategori.update', $kategori->id_kategori) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                placeholder="Nama kategori barang anda" required=""
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4"
                                ...
                                required="" placeholder="deskripsi kategori barang anda">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
