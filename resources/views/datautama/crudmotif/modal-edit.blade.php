@foreach ($motifs as $motif)
    <!-- Main modal -->
    <div id="edit-motif-modal{{ $motif->id_motif }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('motif.update', $motif->id_motif) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama_motif" id="nama_motif"
                                ...
                                placeholder="Nama motif barang anda" required=""
