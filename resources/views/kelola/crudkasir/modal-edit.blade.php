@foreach ($kasirs as $kasir)
    <!-- Main modal -->
    <div id="edit-kasir-modal{{ $kasir->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('kelolakasir.update', $kasir->id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                placeholder="Nama kasir anda" required="" value="{{ old('nama', $kasir->name) }}">
                            @error('nama')
                        ...
                        <div class="col-span-2">
                            ...
                            <input name="username" id="username" rows="4"
                                ...
                                required="" placeholder="Username kasir anda"
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama_toko" id="nama_toko" maxlength="20"
                                ...
                                required placeholder="Nama Toko kasir anda"
                                value="{{ old('nama_toko', $kasir->nama_toko) }}" readonly>
                            @error('nama_toko')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="password" name="password" id="password" maxlength="20"
                                ...
                                placeholder="Password kasir baru (jika ingin diubah)">
                            @error('password')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
