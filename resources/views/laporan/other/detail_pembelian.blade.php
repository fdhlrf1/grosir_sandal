<x-layout>
    <x-slot:title>Detail Pembelian - {{ $pembelian->nopembelian }}</x-slot:title>
    <div class="container px-0 py-2 mx-auto">
        <h1 class="mb-6 text-2xl font-semibold text-gray-800">
            <span class="text-blue-600">Detail Pembelian: {{ $pembelian->nopembelian }}</span>
        </h1>
        ...
        <!-- Tautan kembali ke laporan pembelian -->
